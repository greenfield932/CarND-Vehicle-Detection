...
global framesWithoutRegions
framesWithoutRegions = 0
#car search pipeline, frames processed here
def carPipeline(img, heat, svc, scaler, frameboxes,heatmap, debug = False):
    ...
    averagingFrames = 6     #frames used to establish region
    keepFrames = 5         #how many frames we keep last region if no new vehicle regions appear
    ...
    if useHeat == True:
        ...
        #Reset smoothing between frames when data is too outdated
        ...
        #make average of heat maps between frames
